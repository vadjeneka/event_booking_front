...
const RegisterForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showSuccessToast('Inscription réussie ! Bienvenue sur notre plateforme.');
      navigate('/events');
    } catch (err: any) {
        ...
        <div className="lg:w-1/2 bg-indigo-600 relative hidden lg:block">
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-12">
            <h2 className="text-4xl font-bold text-white mb-6">
              Rejoignez EventBooking
            </h2>
            <p className="text-xl text-indigo-100">
              Créez votre compte pour accéder à tous nos événements et réserver vos places.
            </p>
          </div>
        </div>
